                ...
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 d-none d-md-block p-0">
                            <img src="{{ asset('img/child1.jpeg') }}" alt="login image" class="img-fluid w-100 h-100"
                        ...
                        <div class="col-md-6 p-5" dir="rtl">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="text-center mb-3 mt-2">
                                    <span class="text-muted small">هل نسيت كلمة المرور؟</span>
                                    <a href="{{ route('password.request') }}" class="fw-bold text-decoration-none small"
                                        style="color: #031f3d;">
